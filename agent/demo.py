...
Used when GEMINI_API_KEY is not set so the app runs without any API calls.
"""
...
_SONGS = {
    "s001": {
        ...
        "mood": "peaceful",
        "energy": 0.15,
        "tags": ["calm", "introspective", "gentle", "melancholic"],
    },
    "s002": {
        "id": "s002",
        ...
        "mood": "sad",
        "energy": 0.38,
        "tags": ["sad", "heartbreak", "longing", "emotional"],
    },
    "s003": {
        "id": "s003",
        "title": "Fix You",
        ...
        "mood": "hopeful",
        "energy": 0.52,
        "tags": ["hopeful", "comforting", "emotional", "uplifting"],
    },
    "s005": {
        "id": "s005",
        "title": "Weightless",
        ...
        "mood": "calm",
        "energy": 0.08,
        "tags": ["anxiety-relief", "calm", "serene", "meditative"],
    },
    "s006": {
        "id": "s006",
        ...
        "mood": "euphoric",
        "energy": 0.95,
        "tags": ["euphoric", "energetic", "exhilarating", "fun"],
    },
    "s007": {
        "id": "s007",
        ...
        "mood": "nostalgic",
        "energy": 0.28,
        "tags": ["nostalgic", "melancholic", "longing", "reflective"],
    },
    "s009": {
        "id": "s009",
        ...
        "mood": "melancholic",
        "energy": 0.12,
        "tags": ["melancholic", "introspective", "gentle", "serene"],
    },
    "s011": {
        "id": "s011",
        ...
        "mood": "hopeful",
        "energy": 0.58,
        "tags": ["hopeful", "warm", "optimistic", "uplifting"],
    },
    "s013": {
        "id": "s013",
        "title": "Lose Yourself",
        ...
        "mood": "motivated",
        "energy": 0.91,
        "tags": ["motivated", "intense", "focused", "determined"],
    },
    "s017": {
        "id": "s017",
        ...
        "mood": "motivated",
        "energy": 0.89,
        "tags": ["motivated", "determined", "triumphant", "powerful"],
    },
    "s018": {
        "id": "s018",
        "title": "Bloom",
        ...
        "mood": "content",
        "energy": 0.25,
        "tags": ["content", "warm", "gentle", "romantic"],
    },
    "s019": {
        "id": "s019",
        ...
        "mood": "uplifting",
        "energy": 0.75,
        "tags": ["uplifting", "triumphant", "cathartic", "energetic"],
    },
    "s020": {
        "id": "s020",
        "title": "Mad World",
        ...
        "mood": "melancholic",
        "energy": 0.18,
        "tags": ["melancholic", "existential", "sad", "reflective"],
    },
    "s021": {
        "id": "s021",
        "title": "Good as Hell",
        ...
        "mood": "empowered",
        "energy": 0.82,
        "tags": ["empowered", "confident", "joyful", "self-love"],
    },
    "s022": {
        "id": "s022",
        "title": "Holocene",
        ...
        "mood": "introspective",
        "energy": 0.20,
        "tags": ["introspective", "vast", "melancholic", "beautiful"],
    },
    "s024": {
        "id": "s024",
        "title": "Hallelujah",
        ...
        "mood": "bittersweet",
        "energy": 0.25,
        "tags": ["bittersweet", "spiritual", "emotional", "tender"],
    },
    "s025": {
        "id": "s025",
        "title": "Golden Hour",
        ...
        "mood": "hopeful",
        "energy": 0.60,
        "tags": ["hopeful", "romantic", "warm", "uplifting"],
    },
    "s026": {
        "id": "s026",
        "title": "Let Her Go",
        ...
        "mood": "nostalgic",
        "energy": 0.32,
        "tags": ["nostalgic", "regret", "reflective", "heartfelt"],
    },
    "s027": {
        "id": "s027",
        "title": "September",
        ...
        "mood": "euphoric",
        "energy": 0.90,
        "tags": ["euphoric", "joyful", "danceable", "nostalgic-happy"],
    },
    "s028": {
        "id": "s028",
        "title": "Yesterday",
        ...
        "mood": "melancholic",
        "energy": 0.20,
        "tags": ["melancholic", "wistful", "tender", "reflective"],
    },
    "s033": {
        "id": "s033",
        ...
        "mood": "happy",
        "energy": 0.88,
        "tags": ["happy", "exuberant", "classic", "upbeat"],
    },
    "s035": {
        "id": "s035",
        "title": "Stressed Out",
        ...
        "mood": "anxious",
        "energy": 0.65,
        "tags": ["anxious", "nostalgic", "relatable", "generational"],
    },
    "s036": {
        "id": "s036",
        "title": "Experience",
        ...
        "mood": "serene",
        "energy": 0.16,
        "tags": ["serene", "transcendent", "beautiful", "meditative"],
    },
    "s039": {
        "id": "s039",
        "title": "Beautiful Day",
        ...
        "mood": "uplifting",
        "energy": 0.72,
        "tags": ["uplifting", "hopeful", "anthemic", "joyful"],
    },
    "s044": {
        "id": "s044",
    ...
    "s047": {
        ...
        "mood": "introspective",
        "energy": 0.38,
        "tags": ["introspective", "wisdom", "calm-down", "reassuring"],
    },
    "s049": {
        "id": "s049",
        "title": "Rise Up",
        ...
        "mood": "uplifting",
        "energy": 0.58,
        "tags": ["uplifting", "resilient", "powerful", "soulful"],
    },
    "s057": {
        "id": "s057",
        "title": "This Is Me",
        ...
        "mood": "empowered",
        "energy": 0.80,
        "tags": ["empowered", "triumphant", "self-acceptance", "anthemic"],
    },
    "s060": {
        "id": "s060",
        "title": "The Scientist",
        ...
        "mood": "bittersweet",
        "energy": 0.32,
        "tags": ["bittersweet", "regret", "reflective", "heartfelt"],
    },
}
...
def _ann(
    sid: str, mood: str, step: int, note: str, why: str, psych: str = ""
) -> AnnotatedSong:
    s = _song(sid)
...
def _journey_motivation(user_input: str) -> JourneyResult:
    ...
    arc_plan = EmotionalArc(
        ...
        transition_rationale=[
            "break the inertia",
            "build a little warmth",
            "ignite forward momentum",
        ],
    )
...
def _journey_nostalgic(user_input: str) -> JourneyResult:
    ...
    arc_plan = EmotionalArc(
        ...
        transition_rationale=[
            ...
            "feel the bittersweet",
            "find the gratitude in it",
...
_RULES: list[tuple[list[str], object]] = [
    ...
    (
        ["happy", "celebrat", "great news", "amazing", "euphoric", "party"],
        _journey_euphoric,
    ),
]
